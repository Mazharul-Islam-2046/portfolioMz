    ...
    return (
        <div id="projects" className="mb-14 mt-16">
            ...
            <div className="grid grid-cols-2 mx-auto py-6">
                ...
                <InView>
                    <div className="px-10 py-14 text-left">
                        <h3 className="text-3xl text-orange-400 font-secondary font-bold mb-8">Blood Donation</h3>
                        ...
                        <button className="text-lg font-semibold font-secondary py-2 px-6 border-2 border-gray-800 rounded-md mt-12 hover:bg-orange-400 hover:border-0 hover:text-white"><a href="https://blood-donation-client-e03ab.web.app/">Live Link</a></button>
                    </div>
                </InView>
            ...
            <div className="grid grid-cols-2 mx-auto py-6">
                ...
                <InView>
                    <div className="px-10 py-14 text-left">
                        <h3 className="text-3xl text-orange-400 font-secondary font-bold mb-8">Camera And Gear Renting Site</h3>
                        ...
                        <button className="text-lg font-semibold font-secondary py-2 px-6 border-2 border-gray-800 rounded-md mt-12 hover:bg-orange-400 hover:border-0 hover:text-white"><a href="https://camr-e98af.web.app/">Live Link</a></button>
                    </div>
                </InView>
            </div>
            {/* <div> */}
