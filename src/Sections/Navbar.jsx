    ...
    return (
        <div>
            ...
            <div className='flex justify-between px-5 pb-8 pt-2 border-b-2 border-gray-100'>
                <div className='text-2xl uppercase font-secondary font-bold text-gray-800'><a href="#"><span className="text-orange-400">Mazharul</span> Islam</a></div>
                <div className='font-secondary flex gap-x-7 font-semibold text-gray-700'>
                    ...
                    <div className='border-l-0 border-orange-400 hover:text-orange-400 hover:border-b-2'><a href="#">Contact Me</a></div>
                </div>
            </div>
            </InView>
        </div>
